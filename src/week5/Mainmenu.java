...
public class Mainmenu {
	...
	private Runselectnumber createnumber(int type) {
		...
		switch (type) {
		case 1:
			temp=new Printarraychar(t);
			break;
		case 2:
			temp=new Printarraysum(t);
			break;
		case 3:
			temp=new calmodper(t);
			break;
		case 4:
			temp= new Printreverseintarray(t);
			break;
		case 5:
			temp = new Deletefromarray(t);
			break;
		case 6:
			temp = new Addfromarray(t);
			break;
		case 7:
			temp= new Arrayspecifynumcount(t);
			break;
		case 8:
